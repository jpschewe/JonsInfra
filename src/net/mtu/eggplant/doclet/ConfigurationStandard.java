...
public class ConfigurationStandard extends Configuration {
  ...
  public ConfigurationStandard() {
    //System.out.println(java.util.ResourceBundle.getBundle("net.mtu.eggplant.doclet.resources.standard"));
    if (standardmessage == null) {
      standardmessage = 
        //new MessageRetriever("com.sun.tools.javadoc.resources.standard");
        //new MessageRetriever("net.mtu.eggplant.doclet.resources.standard");
        new MessageRetriever(java.util.ResourceBundle.getBundle("net.mtu.eggplant.doclet.resources.standard"));
    }
  }
