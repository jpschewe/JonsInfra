...
apt -nocompile \
  -factorypath ${mypath}/build/classes/main:${mypath}/lib/slf4j-api-1.5.11.jar:${mypath}/lib/findbugs-1.3.9/lib/annotations.jar:${mypath}/lib/findbugs-1.3.9/lib/jsr305.jar:${mypath}/lib/test/slf4j-simple-1.5.11.jar \
