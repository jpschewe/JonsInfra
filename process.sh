...
apt -factorypath ${mypath}/build/classes/main:${mypath}/lib/slf4j-api-1.5.3.jar:${mypath}/lib/findbugs-1.3.9/lib/annotations.jar:${mypath}/lib/findbugs-1.3.9/lib/jsr305.jar \
